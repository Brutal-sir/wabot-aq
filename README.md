...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Brutal-sir/wabot-aq)
...
git clone https://github.com/Brutal-sir/wabot-aq
cd wabot-aq
npm install
npm update
```
